...
export default function ClientSelector({ onClientChange, currentClient }: ClientSelectorProps) {
      ...
      <div className="max-w-7xl mx-auto flex items-center gap-4">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className={`w-full p-3 border-2 rounded-2xl outline-none text-sm transition-all ${selected
